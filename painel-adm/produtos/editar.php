...
if($reg_antigo != $nome){
 ...
 if ($_FILES['foto']['name'] == ""){
    $res = $pdo->prepare("UPDATE produtos SET nome = :nome, descricao = :descricao, descricao_longa = :descricao_longa, valor = :valor, categoria = :categoria, nome_url = :nome_url where id = :id");
 }else{
    $res = $pdo->prepare("UPDATE produtos SET nome = :nome, descricao = :descricao, descricao_longa = :descricao_longa, valor = :valor, categoria = :categoria, nome_url = :nome_url, imagem = :imagem where id = :id");
